g This script by Sej has been midfied by Emma to fix a python bug 
#17/07/19
...
## New python v2 command below
glias python=/bin/python2 
...
diamond blastx -d /db/diamond2/ViralRefSeqProtein -p $threads -q $3_garm_combined.fa -a $3_garm_combined_contigs_diamond -t $3_temp_dir --top 1

diamond blastx -d /db/diamond2/nr -p $threads -q $3_garm_combined.fa -a $3_garm_combined_contigs_diamond_nr -t $3_temp_dir --top 1

diamond view -a $3_garm_combined_contigs_diamond.daa -o $3_garm_combined_contigs_diamond.m8 
diamond view -a $3_garm_combined_contigs_diamond_nr.daa -o $3_garm_combined_contigs_diamond_nr.m8 
...
ktImportBLAST $3_garm_combined_contigs_diamond_nr.m8 -o $3_contigs_diamond_krona_nr.html
