...
mkdir $3_temp_dir
diamond blastx -d /db/diamond2/ViralRefSeqProtein -p $threads -q $3_nonrrna_R1.fq -a $3_R1_diamond -t $3_temp_dir -k 1
diamond blastx -d /db/diamond2/ViralRefSeqProtein -p $threads -q $3_nonrrna_R2.fq -a $3_R2_diamond -t $3_temp_dir -k 1
...
gwk 'FNR==NR{a[$1]=1;}FNR!=NR{if(a[$1]==1) print}'  $3_R1_gi_unique $tax_loc/gi_taxid_prot.dmp > $3_R1_match_gi_taxid
